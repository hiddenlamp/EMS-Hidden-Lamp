...
console.log('=== BUILDING REACT SPA & PREPARING HOSTINGER PACKAGE ===\n');

try {
  console.log('  🔨 Executing Vite React Build (npm run build)...');
  execSync('npm run build', { cwd: frontendDir, stdio: 'inherit' });
  console.log('  ✅ React SPA built successfully into frontend/dist-hostinger');
} catch (err) {
...
console.log('  ✅ Created Hostinger React SPA .htaccess file');
